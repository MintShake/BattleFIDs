    ...
    (
      ...
      >
        ...
        <div style={{
          ...
          width: 480, height: 300, borderRadius: '0 0 50% 50%',
        ...
        {/* Rings */}
        <div style={{ position: 'absolute', width: 420, height: 420, borderRadius: '50%', border: '1px solid rgba(201,168,76,0.25)', display: 'flex' }} />
        <div style={{ position: 'absolute', width: 360, height: 360, borderRadius: '50%', border: '1px solid rgba(138,99,210,0.2)', display: 'flex' }} />

        {/* Roman arch */}
        <div style={{
          position: 'absolute', top: 56, left: '50%', transform: 'translateX(-50%)',
          width: 240, height: 140, borderRadius: '0 0 120px 120px',
          border: '2px solid rgba(201,168,76,0.35)', borderTop: 'none', display: 'flex',
        }} />
        <div style={{
          position: 'absolute', top: 56, left: '50%', transform: 'translateX(-50%)',
          width: 170, height: 100, borderRadius: '0 0 85px 85px',
          border: '1px solid rgba(138,99,210,0.22)', borderTop: 'none', display: 'flex',
        }} />

        {/* P + crayon */}
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative', marginTop: 24 }}>
          <div style={{
            fontSize: 210, fontWeight: 900, lineHeight: 0.85,
          ...
          <div style={{
            ...
            textShadow: '1px 0px 0 rgba(230,57,70,0.4), -1px 1px 0 rgba(230,57,70,0.3), 2px -1px 0 rgba(230,57,70,0.25)',
            display: 'flex',
          }}>
            2026 edition
          </div>
          ...
          <div style={{
            fontSize: 17, fontWeight: 700, letterSpacing: '0.5em',
